...
class SupplierProject extends Model
{
    ...
    protected $fillable = ['project_id', 'company_id','project_link_id','supplier_id', 'supplier_link','cpi', 'terminate_url', 'quotafull_url', 'complete_url', 'security_terminate_url', 'sample_size', 'notes','status'];
