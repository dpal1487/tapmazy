...
<template>
    <AppLayout>
        ...
        <template #breadcrumb>
            ...
            <li class="breadcrumb-item">
                <Link href="/support/tutorials" class="text-muted text-hover-primary">Tutorials</Link>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="h-100 d-flex flex-column justify-content-between pe-lg-6 mb-lg-0 mb-10">
                                ...
                                <div class="mb-5">
                                    <!--begin::Title-->
                                    <a href="#" class="fs-2 text-dark fw-bold text-hover-primary text-dark lh-base">Admin
                                        Panel - How To Get Started Tutorial.
                                        <br />Create easy customizable applications</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-5 text-gray-600 text-dark mt-4">We’ve been focused on making
                                        the from v4 to v5 but we have also not been afraid to step away been focused on from
                                        v4 to v5 speaker approachable making focused a but from a step away afraid to step
                                        away been focused Writing a blog post is a little like driving; you can study the
                                        highway code (or read articles telling you how to write a blog post) for months, but
                                        nothing can prepare you for the real thing like getting behind the wheel</div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Body-->
                                <!--begin::Footer-->
                        ...
                        <div class="col-md-6 justify-content-between d-flex flex-column">
                            ...
                            <div class="ps-lg-6 mb-16 mt-md-0 mt-17">
                                ...
                                <div class="mb-6">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-5 mt-4 text-gray-600 text-dark">We’ve been focused on making
                                        the from v4 to v5 a but we’ve also not been afraid to step away been focused on from
                                        v4 to v5 speaker approachable making focused</div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Body-->
                                <!--begin::Footer-->
                            ...
                            <div class="ps-lg-6 mb-16">
                                ...
                                <div class="mb-6">
                                    <!--begin::Title-->
                                    <a href="#" class="fw-bold text-dark mb-4 fs-2 lh-base text-hover-primary">Angular Admin
                                        Theme - How To Get Started Tutorial.</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-5 mt-4 text-gray-600 text-dark">We’ve been focused on making
                                        the from v4 to v5 a but we’ve also not been afraid to step away</div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Body-->
                                <!--begin::Footer-->
                            ...
                            <div class="ps-lg-6">
                                ...
                                <div class="mb-6">
                                    <!--begin::Title-->
                                    <a href="#" class="fw-bold text-dark mb-4 fs-2 lh-base text-hover-primary">React Admin
                                        Theme - How To Get Started Tutorial. Create best applications</a>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-5 mt-4 text-gray-600 text-dark">We’ve been focused on making
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <div class="mt-5">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-5 text-gray-600 text-dark mt-3">We’ve been focused on making
                                        a the from also not been eye</div>
                                    <!--end::Text-->
                                    <!--begin::Text-->
                                    ...
                                    <div class="dz-message needsclick align-items-center">
                                        ...
                                        <div class="ms-4">
                                            <h3 class="fs-5 fw-bold text-gray-900 mb-1">Drop files here or
                                                click to upload.</h3>
                                            <span class="fw-semibold fs-7 text-gray-400">Upload up to 10
                                                files</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
