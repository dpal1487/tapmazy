...
export default defineComponent({
    props: ['clients', 'currencies', 'status' , 'allowed_invoices' , 'invoices'],
    setup() {
...
<template>
    ...
    <AppLayout :title="title">
        ...
        <div class="app-content flex-column-fluid">
            <div v-if="invoices > allowed_invoices?.data?.allowed_invoices">
                <PlanWarning :data="allowed_invoices?.data" />
            </div>
            <div v-else>
                <JetValidationErrors />
                                ...
                                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="mb-0">
                                        <div class="row d-flex align-items-start">
                                            <div class="col-6">
                                                <div class="form-control form-control-solid"><b>From :</b> A.R Solution
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="d-flex mt-5 flex-column gap-2 text-gray-600 fs-5">
                                                    <textarea rows="3" class="form-control form-control-solid"
                                                        v-model="v$.form.from_address.$model" :class="v$.form.from_address.$errors.length > 0
                                                            ...
                                                            : ''
                                                            " readonly></textarea>
                                                    <div v-for="(error, index) of v$.form.from_address.$errors"
                                                        :key="index">
                                                        <input-error :message="error.$message" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <textarea rows="3"
                                                    class="form-control from-control-lg form-control-solid mt-5"
                                                ...
                                                <tbody>
                                                    <tr v-for="(item, index) in form.items" :key="index"
                                                        ...
                                                        <td> <input type="text" class="form-control form-control-solid"
                                                                v-model="item.cpi"
                                                                :placeholder="`${form.currency.symbol}0.00`"
                                                                @keyup="handler()" />
                                                        </td>

                                                        <td class="ps-0">
                                                            <input class="form-control form-control-solid" type="number"
                                                                v-model="item.quantity" placeholder="1"
                                                                @keyup="handler()" />
                                                        </td>
                                                ...
                                                <tfoot>
                                                    <tr
                                                        ...
                                                        <th colspan="4" class="border-bottom border-bottom-dashed ps-0">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            v-model="form.tax_rate" @keyup="handler()"
                                                                            :class="v$.form.tax_rate.$errors.length > 0
                                                                                ? 'is-invalid'
                                                                                : ''
                                                                                " />
                                                            ...
                                                            <div
                                                                class="d-flex align-items-center justify-content-between mb-1">
                                                                <div class="text-grey py-1 fs-6">Applied Exchange Rate :
                                                                </div>
                                                                <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="card position-sticky top-0">
                            <div class="card-body p-10">
                                <div class="mb-5">
                                    ...
                                    <select class="form-control form-control-lg form-control-solid mb-2"
                                        v-model="v$.form.currency.$model" :class="v$.form.currency.$errors.length > 0
                                            ...
                                            : ''
                                            ">
                                        <option v-for="(currency, index) in currencies.data" :key="currency"
                                            :value="currency">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="date" v-model="v$.form.due_date.$model"
                                        class="form-control form-control-solid" :class="v$.form.due_date.$errors.length > 0
                                            ? 'is-invalid'
                                            : ''
                                            " placeholder="Select date" />
