    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div v-if="canLogin" class="d-flex justify-content-end">
                                <div>
                                    <Link v-if="$page?.props?.user" :href="route('dashboard')" class="btn btn-success">
                                    Dashboard
                                    </Link>
                                    <template v-else>
                                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                                            <Link v-if="canRegister" :href="route('register')" class="btn btn-success">
                                            Register
                                            </Link>
                                            <Link :href="route('login')" class="btn btn-success">Sign In</Link>
                                        </div>
                                    </template>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px counted">700+</div>
                                    </div>
                                    <!--end::Value-->
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <i class="ki-duotone ki-chart-pie-4 fs-2tx text-white mb-3"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span></i> <!--end::Symbol-->

                                <!--begin::Info-->
                                <div class="mb-0">
                                    <!--begin::Value-->
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px counted">80K+</div>
                                    </div>
                                    <!--end::Value-->
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                ...
                                <div class="mb-0">
                                    <!--begin::Value-->
                                    <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                                        <div class="min-w-70px counted">35M+</div>
                                    </div>
                                    <!--end::Value-->
            ...
            <div class="container">
                ...
                <div class="tns tns-default tns-initiazlied">
                    ...
                    <div class="tns-outer" id="tns2-ow">
                        <div class="tns-liveregion tns-visually-hidden">slide <span class="current">5 to 7</span> of 7</div>
                        <div class="tns-ovh">
                            <div class="tns-inner" id="tns2-iw">
                                <div class="tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    style="transition-duration: 0s; transform: translate3d(-26.6667%, 0px, 0px);">
                                    <div class="text-center tns-item tns-slide-cloned">
                                        <!--begin::Photo-->
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="text-center tns-item" id="tns2-item3">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('/assets/media/avatars/300-20.jpg')">
                                        </div>
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="text-center tns-item" id="tns2-item4">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('/assets/media/avatars/300-23.jpg')">
                                        </div>
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="text-center tns-item" id="tns2-item5">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('/assets/media/avatars/300-12.jpg')">
                                        </div>
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="text-center tns-item" id="tns2-item6">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                            style="background-image:url('/assets/media/avatars/300-9.jpg')">
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column container pt-lg-20">
                        ...
                        <div class="mb-13 text-center">
                            <h1 class="fs-2hx fw-bold text-white mb-5">
                        ...
                        <div class="text-center">
                            <!--begin::Row-->
                            <div class="row g-10">
                                <div v-for="(plan, index) in plans?.data" :key="index" class="col-xl-4">
        ...
        <div class="mt-20 mb-n20 position-relative z-index-2">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-dark mb-5" id="clients">What Our Clients
                        Say</h3>
                    <!--end::Title-->
