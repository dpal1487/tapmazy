    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                id: this.privacy_policy?.id || '',
                privacy_policy: this.privacy_policy?.content || '',
            })
        ...
        submit() {
            ...
            if (!this.v$.form.$invalid) {
                this.form
                    ...
                    .post(this.route('page.privacy-policy.store', this.id),
                        {
                            onSuccess: (data) => {
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="fv-row col-12">
                                            <ckeditor :editor="editor" v-model="v$.form.privacy_policy.$model"
