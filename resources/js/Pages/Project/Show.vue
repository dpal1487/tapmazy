...
import ProjectLinkForm from "./Components/Modal/ProjectLinkForm.vue"
...
<template>
    ...
    <app-layout :title="title">
        ...
        <template #toolbar v-if="$page.props.user.role.role.slug == 'admin'">
        ...
        <LinkList :links="project_links.data" :countries="countries?.data" />
    </app-layout>
</template>
