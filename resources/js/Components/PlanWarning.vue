            ...
            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-12 p-6">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="fw-semibold">
                        ...
                        <div class="fs-6 text-gray-700">Your plan was exceeded. To start using tools, please
                            <Link :href="`/subscription/plan-update/${data?.subscription?.id}`" class="fw-bold">update
                            plan</Link>.
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="d-flex justify-content-end pb-0 px-0">
                        <Link :href="`/subscription/plan-update/${data?.subscription?.id}`" class="btn btn-sm btn-primary">Upgrade
                        plan</Link>
                    </div>
                </div>
            </div>
